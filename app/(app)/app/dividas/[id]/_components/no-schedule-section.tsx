  ...
  return (
    <section className="rounded-2xl border border-[color:var(--border-soft)] bg-[color:var(--surface-1)] p-4 backdrop-blur-xl">
      ...
      <p className="mt-2 text-[0.75rem] text-[color:var(--text-muted)]">
        {kind === "credit_card"
          ? "Cartão não tem parcela fixa; veja os pagamentos abaixo."
          : kind === "overdraft"
            ? "Cheque especial cobra juros sobre o saldo, sem parcela fixa."
            : "Sem cronograma de parcelas para este tipo."}
      </p>
    </section>
  );
}
