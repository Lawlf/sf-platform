  ...
  return (
    ...
    >
      <div className="mb-2.5 flex items-baseline justify-between">
        <div className="font-serif text-[1.75rem] font-bold leading-none tracking-[-0.02em] text-[color:var(--text-primary)]">
      ...
      <div className="grid grid-cols-7 gap-1.5">
        {WEEKDAY_LABELS.map((label, idx) => (
          <div
            key={idx}
            className={`grid aspect-square place-items-center rounded-md text-[0.625rem] font-bold ${
              idx === today
