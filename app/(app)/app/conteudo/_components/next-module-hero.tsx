...
export function NextModuleHero({ module }: NextModuleHeroProps) {
  return (
    ...
    >
      ...
      />
      <div className="mb-2.5 inline-flex items-center gap-1.5 text-[10.5px] font-bold uppercase tracking-[0.08em] text-[color:var(--text-secondary)]">
        <span
      ...
      <h2 className="font-serif text-[22px] font-bold leading-[1.2] tracking-[-0.015em] text-[color:var(--text-primary)]">
        {module.title}
      </h2>
      <p className="mt-2 text-[12px] text-[color:var(--text-secondary)]">
        Capítulo {String(module.num).padStart(2, "0")} · {module.subtitle}
      </p>
      <div className="mt-4 flex items-center gap-2 rounded-[12px] border border-dashed border-[color:var(--border-soft)] bg-[color:var(--surface-3)] px-3.5 py-2.5 text-[12px] text-[color:var(--text-secondary)]">
