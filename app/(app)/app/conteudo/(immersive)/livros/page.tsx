    ...
    <div className="flex flex-col gap-6">
      ...
      {TRILHAS.map((trilha) => (
        <section key={trilha.slug}>
          <div className="mb-2 px-1 text-[11px] font-bold uppercase tracking-[0.08em] text-[color:var(--text-secondary)]">
            {trilha.title}
          </div>
          {trilha.books.length > 0 ? (
            ...
            <p className="rounded-[14px] border border-dashed border-[color:var(--border-soft)] bg-[color:var(--surface-1)] p-4 text-[12px] text-[color:var(--text-muted)]">
