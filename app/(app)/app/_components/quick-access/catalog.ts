...
export const QUICK_ACCESS_CATALOG: CatalogEntry[] = [
  ...
  { key: "add_asset", label: "Adicionar patrimônio", shortLabel: "Patrimônio", href: "/app/patrimonio/novo", category: "adicionar", icon: "Coins" },
  { key: "add_transaction", label: "Entrada ou saída", shortLabel: "Entrada/saída", href: "/app/lancar", category: "adicionar", icon: "ArrowLeftRight" },
  { key: "sim_quitacao", label: "Quanto pra quitar uma dívida", shortLabel: "Quitar", href: "/app/simular/quitacao", category: "simular", icon: "Target" },
  ...
  { key: "sim_compra", label: "Vale a pena comprar?", shortLabel: "Compra", href: "/app/simular/compra", category: "simular", icon: "Calculator" },
  { key: "sim_regra_de_tres", label: "Regra de três", shortLabel: "Regra 3", href: "/app/simular/regra-de-tres", category: "simular", icon: "Divide" },
  { key: "sim_hub", label: "Simuladores", shortLabel: "Simular", href: "/app/simular", category: "simular", icon: "PlusCircle" },
  { key: "metas", label: "Minhas metas", shortLabel: "Metas", href: "/app/metas", category: "navegar", icon: "Target" },
