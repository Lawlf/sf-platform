  ...
  return (
    <SimpleTooltip label={hidden ? "Mostrar valores" : "Esconder valores"} side="bottom">
      <button
        ...
        className={
          className ??
          "focus-ring flex h-9 w-9 items-center justify-center rounded-full bg-[color:var(--surface-1)] text-[color:var(--text-primary)] transition-colors hover:bg-[color:var(--surface-2)]"
        }
      >
        {hidden ? (
