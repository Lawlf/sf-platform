import { ArrowRight, ChevronRight, Landmark, Lock, Rocket, ShieldCheck, Target } from "lucide-react";
...
export function GoalCard({ data, showType = true }: GoalCardProps) {
  ...
  return (
    ...
    >
      <div className="min-w-0 flex-1 flex flex-col gap-3">
        ...
        {noTarget ? (
          <span className="inline-flex w-fit items-center gap-1 rounded-full bg-[color:var(--color-brand-500)]/[0.14] px-2.5 py-1 text-[0.75rem] font-bold text-[color:var(--color-brand-800)]">
            Definir valor
