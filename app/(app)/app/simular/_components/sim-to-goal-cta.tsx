...
export function SimToGoalCta({ seed, label }: { seed: GoalSeed; label?: string }) {
  const pathname = usePathname();
  if (isPublicCalc(pathname)) return <SimSignupCta label="Criar conta para acompanhar como meta" />;
