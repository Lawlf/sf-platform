...
import { EntityAttachmentRepository } from "./entity-attachment.repository";
import { UserRepository } from "./user.repository";

const TEST_EMAIL = "it-test-entity-attachment@saborfinanceiro.com.br";
const users = new UserRepository();
const repo = new EntityAttachmentRepository();
let userId: string;
...
describe("EntityAttachmentRepository (integration)", () => {
