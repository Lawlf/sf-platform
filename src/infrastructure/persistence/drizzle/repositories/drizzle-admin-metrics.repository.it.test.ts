...
import { DrizzleAdminMetricsRepository } from "./drizzle-admin-metrics.repository";
import { DrizzleUserRepository } from "./drizzle-user.repository";


const EMAIL = "it-admin-metrics@saborfinanceiro.com.br";
const users = new DrizzleUserRepository();
const repo = new DrizzleAdminMetricsRepository();
let userId: string;
...
describe("DrizzleAdminMetricsRepository (integration)", () => {
