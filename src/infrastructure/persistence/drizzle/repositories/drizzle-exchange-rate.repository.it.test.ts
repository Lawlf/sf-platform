...
import { DrizzleExchangeRateRepository } from "./drizzle-exchange-rate.repository";

const TEST_SOURCE = "it-test-exchange-rate-source";

const repo = new DrizzleExchangeRateRepository();
...
describe("DrizzleExchangeRateRepository (integration)", () => {
