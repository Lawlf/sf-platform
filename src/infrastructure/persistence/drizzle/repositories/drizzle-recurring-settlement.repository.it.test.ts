...
import { DrizzleRecurringSettlementRepository } from "./drizzle-recurring-settlement.repository";
...
const repo = new DrizzleRecurringSettlementRepository();
...
describe("DrizzleRecurringSettlementRepository (integration)", () => {
