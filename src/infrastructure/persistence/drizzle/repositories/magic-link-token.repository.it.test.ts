...
import { MagicLinkTokenRepository } from "./magic-link-token.repository";
import { UserRepository } from "./user.repository";

const users = new UserRepository();
const tokens = new MagicLinkTokenRepository();
...
describe("MagicLinkTokenRepository (integration)", () => {
