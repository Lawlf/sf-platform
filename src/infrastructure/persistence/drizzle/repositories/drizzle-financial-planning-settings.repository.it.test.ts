...
import { DrizzleFinancialPlanningSettingsRepository } from "./drizzle-financial-planning-settings.repository";
...
const repo = new DrizzleFinancialPlanningSettingsRepository();
...
describe("DrizzleFinancialPlanningSettingsRepository (integration)", () => {
