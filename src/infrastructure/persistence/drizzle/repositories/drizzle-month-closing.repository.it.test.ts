...
import { DrizzleMonthClosingRepository } from "./drizzle-month-closing.repository";
import { DrizzleUserRepository } from "./drizzle-user.repository";

const TEST_EMAIL = "it-test-month-closing-user@saborfinanceiro.com.br";

const users = new DrizzleUserRepository();
const repo = new DrizzleMonthClosingRepository();
let userId: string;
...
describe("DrizzleMonthClosingRepository (integration)", () => {
