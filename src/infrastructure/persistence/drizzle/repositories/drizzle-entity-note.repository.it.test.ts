...
import { DrizzleEntityNoteRepository } from "./drizzle-entity-note.repository";
import { DrizzleUserRepository } from "./drizzle-user.repository";

const TEST_EMAIL = "it-test-entity-note@saborfinanceiro.com.br";
const users = new DrizzleUserRepository();
const repo = new DrizzleEntityNoteRepository();
let userId: string;
...
describe("DrizzleEntityNoteRepository (integration)", () => {
