...
import type { UserAvatarRepositoryPort } from "@/domain/ports/repositories/user-avatar.repository";

import { getDb } from "../client";
import { userAvatars } from "../schema/user-avatars.schema";

export class UserAvatarRepository implements UserAvatarRepositoryPort {
