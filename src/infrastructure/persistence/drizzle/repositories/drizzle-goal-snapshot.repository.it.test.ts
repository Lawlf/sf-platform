...
import { DrizzleGoalSnapshotRepository } from "./drizzle-goal-snapshot.repository";
...
const goalRepo = new DrizzleGoalRepository();
const repo = new DrizzleGoalSnapshotRepository();
let userId: string;
let goalId: string;
...
describe("DrizzleGoalSnapshotRepository (integration)", () => {
