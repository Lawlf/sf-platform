  ...
  it("maps a debt_payoff goal to a payoff input using the linked debt balance and rate", () => {
    const macro: GoalMacro = {
      ...
      debts: [
        {
          id: "d1",
          originalPrincipalCents: 200000n,
          currentBalanceCents: 150000n,
          monthlyPaymentCents: 30000n,
          annualRatePct: 24,
        },
      ],
    };
    ...
    const assets = [
      {
        ...
        acquiredAt: null,
        depreciationKind: "stable" as const,
