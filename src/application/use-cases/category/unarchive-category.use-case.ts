...
export async function unarchiveCategory(
  deps: { userCategories: UserCategoryRepositoryPort },
  {
    ...
    domain,
    key,
  }: { userId: string; isPro: boolean; domain: CategoryDomain; key: string },
): Promise<void> {
  requirePro(isPro);
