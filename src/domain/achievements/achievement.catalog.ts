...
export const ACHIEVEMENTS: readonly AchievementDef[] = [
  ...
  },
  {
    slug: "saude-verde-3m",
    title: "Saúde verde",
    description: "Suas parcelas ficaram abaixo de 30% da renda por 3 meses seguidos.",
    iconName: "HeartPulse",
    detection: "sustained",
  },
  {
  ...
  {
    slug: "jornada-60m",
    title: "Cinco anos firme",
    description: "Cinco anos acompanhando suas finanças.",
    iconName: "Trophy",
    detection: "tenure",
  },
];
