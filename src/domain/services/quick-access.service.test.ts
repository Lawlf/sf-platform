...
describe("constants", () => {
  it("MAX is 8 and default is the add actions plus simular and metas", () => { expect(MAX_QUICK_ACCESS).toBe(8); expect(DEFAULT_QUICK_ACCESS).toEqual(["add_debt","add_income","add_asset","add_transaction","sim_hub","metas"]); });
});
